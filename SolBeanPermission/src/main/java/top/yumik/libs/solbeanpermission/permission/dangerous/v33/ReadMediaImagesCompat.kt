...
internal class ReadMediaImagesCompat : IDangerousPermissionCompat {

    override val targetApi: Int = AndroidVersion.ANDROID_13

    override val permission: String = Permission.READ_MEDIA_IMAGES

    override fun isGranted(context: Context): Boolean {
        // 在 Android 14 以上，如果用户授予了部分照片访问，那么 READ_MEDIA_VISUAL_USER_SELECTED 权限状态是授予的，而 READ_MEDIA_IMAGES 权限状态是拒绝的
        // 如果授予了全部的照片访问，那么 READ_MEDIA_VISUAL_USER_SELECTED 和 READ_MEDIA_IMAGES 都是授予的
